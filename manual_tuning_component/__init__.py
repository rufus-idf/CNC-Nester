...
def manual_tuning_canvas(layout, selected_sheet_idx, selected_part_id, grid_rows, snap_enabled=False, snap_size=10.0, show_snap_grid=False, align_snap_enabled=True, align_snap_tolerance=4.0, kerf_prompt_enabled=True, kerf_prompt_threshold=12.0, key=None):
    payload = {
        "layout": layout,
